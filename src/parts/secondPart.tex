...
mise à jour Symfony 5.2 => 5.3, affichait une exception lors de la connexion, car la table User n'a pas d'attribut username. En effet, le username se trouve dans la table \textbf{gaea\_user}, qui est générale pour tous les comptes des sites de Gaea21.
Or il est obligatoire à partir de la version 5.3.
Page tarifs niveaux
Page compte activé
...
+ résolution bugs, ex : mise à jour Symfony 5.2 => 5.3, affichait une exception lors de la connexion, car la table User n'a pas d'attribut username. En effet, le username se trouve dans la table \textbf{gaea\_user}, qui est générale pour tous les comptes des sites de Gaea21.
Or il est obligatoire à partir de la version 5.3.
