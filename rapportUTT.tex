...
\title{Mon stage s'est déroulé au sein de l'association Gaea21 en tant que Lead developpeuse, dans le département IT. \\
...
\\ Le but est de livrer une version du site web fonctionnelle permettant le référencement et l’évaluation de tous les
produits et/ou services professionnels verts proposés
dans une région définie, destiné pour le moment aux entreprises.}
